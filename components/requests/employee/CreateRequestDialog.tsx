...
import LeaveRequestForm, {
  ...
  LeaveRequestFormRef,
} from "@/components/forms/LeaveRequestForm";
import ShiftChangeRequestForm, {
  ShiftChangeRequestFormRef,
} from "@/components/forms/ShiftChangeRequestForm";
import OvertimeRequestForm, {  OvertimeRequestFormRef } from "@/components/forms/OvertimeRequestForm";
import SubmitFooter from "./SubmitFooter";
import { format } from "date-fns";
import { requestService } from "@/services/request.service";
import toast from "react-hot-toast";
import { OvertimeRequest, ShiftChangeRequest } from "@/types/requests";
...
export default function CreateRequestDialog({ open, onOpenChange }: Props) {
  ...
  const handleOvertimeSubmit=async(data:OvertimeRequest)=>{
   try {
    setLoading(true)
      // Call the API to create the shift change request
      await requestService.createOvertimeRequest(data);
