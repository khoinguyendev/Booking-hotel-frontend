import BookingHistorySection from '@/components/room/manager/BookingHistorySection';
import MaintenanceHistorySection from '@/components/room/manager/MaintenanceHistorySection';
import RoomDetailHeader from '@/components/room/manager/RoomDetailHeader';
import RoomImages from '@/components/room/manager/RoomImages';
import RoomInfoCard from '@/components/room/manager/RoomInfoCard';
import RoomOverviewCards from '@/components/room/manager/RoomOverviewCards';
